      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-12">
            ...
            <div className="flex gap-6 text-3xl mb-12">
                <a href="#" className="hover:text-teal-400"><i className="fab fa-x-twitter"></i></a>
                ...
                <a href="#" className="hover:text-teal-400"><i className="fab fa-youtube"></i></a>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-5xl text-center md:text-left border-t border-white/10 pt-12">
                ...
                <div>
                    <h3 className="font-bold uppercase tracking-widest text-teal-400 mb-6">Language</h3>
                    <ul className="space-y-3 font-semibold text-sm">
