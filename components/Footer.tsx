            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-5xl text-center md:text-left border-t border-white/10 pt-12">
                ...
                <div>
                    ...
                    <div className="flex justify-center md:justify-start gap-6 text-2xl">
                        ...
                        <a href="https://www.instagram.com/organizesouthdakota/" className="hover:text-teal-400 transition-colors" aria-label="Instagram" target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram"></i></a>
                        <a href="https://www.facebook.com" className="hover:text-teal-400 transition-colors" aria-label="Facebook" target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook"></i></a>
                        <a href="https://www.tiktok.com/@organizesouthdakota" className="hover:text-teal-400 transition-colors" aria-label="TikTok" target="_blank" rel="noopener noreferrer"><i className="fab fa-tiktok"></i></a>
                    </div>
                </div>
            </div>
        </div>
