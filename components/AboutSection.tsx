        ...
        <div className="grid md:grid-cols-2 gap-12 mt-12">
            <div className="space-y-6">
                <p className="text-xl leading-relaxed font-semibold">
                    Organize SD is designed for first-time and rising organizers, field directors, and volunteer leaders who want to learn how to build grassroots capacity effectively.
                </p>
